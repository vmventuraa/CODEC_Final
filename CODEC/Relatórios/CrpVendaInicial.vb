...
Public Class CrpVendaInicial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CODEC.CrpVendaInicial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpVendaInicial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpVendaInicial = New CrpVendaInicial()
        rpt.Site = Me.Site
        Return rpt
    End Function
