...
Public Class CrpEntradaProduto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CODEC.CrpEntradaProduto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpEntradaProduto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpEntradaProduto = New CrpEntradaProduto()
        rpt.Site = Me.Site
        Return rpt
    End Function
