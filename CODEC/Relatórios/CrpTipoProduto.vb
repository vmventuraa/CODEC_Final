...
Public Class CrpTipoProduto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CODEC.CrpTipoProduto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpTipoProduto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpTipoProduto = New CrpTipoProduto()
        rpt.Site = Me.Site
        Return rpt
    End Function
