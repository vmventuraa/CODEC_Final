...
Public Class CrpVendaCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CODEC.CrpVendaCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpVendaCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpVendaCliente = New CrpVendaCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
